...
if __name__ == "__main__":
    ...
    # 指定参数
    attribute = {}
    attribute["epsilon"] =  0.000009999999747378752
    attribute['momentum'] = 0.8999999761581421

    # 指定output形状, output形状应该和input相同，
    # output_shape = [1,32,112,112]

    # 进行单步推理
    run_bn_op(X, sacle, B, mean, var, attribute)
